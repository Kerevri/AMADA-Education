...
const TOPICS_FALLBACK_AZ: typeof TOPICS_FALLBACK = {
  ...
  "supplements-risk": {
    ...
    subtitle: "Niyə AMADA 'Qidaya Üstünlük' yanaşmasını tövsiyə edir.",
    introContent: "İdman qidaları və bioloji fəallığa malik qida əlavələrinin istifadəsi hazırda geniş yayılıb, lakin idmançılar bu qrup maddələrdən istifadə edərkən xüsusi diqqət yetirməlidirlər.",
    keyFacts: [
      "Tərkibində qadağan edilmiş maddələr mövcud ola bilər — bəzi maddələr etiketdə qeyd edilməyə bilər.",
      "İstehsal prosesi zamanı qadağan edilmiş maddələr ilə kontaminasiya halları baş verə bilər.",
      "Etiketdəki maddələrin adları Qadağan edilmiş Siyahıdakı maddələrin adlarından fərqli şəkildə yazıla bilər.",
      "Qida əlavələri internet vasitəsilə alındıqda xüsusi diqqətlə yanaşılmalıdır.",
      "Məhsulun üzərindəki «herbal/bitki tərkibli», «təbii» yazıların olması təhlükəsiz demək deyil.",
      "«İdmançılar üçün təhlükəsizdir» kimi yanlış ifadələrdən istifadə edilə bilər.",
    ],
    risks: "Ciddi Məsuliyyət: İdmançı bədəninə daxil olan maddələrə görə şəxsən məsuliyyət daşıyır! Qaydanı bilməmək və ya étikete aldanmaq sizi qorumayacaq.",
