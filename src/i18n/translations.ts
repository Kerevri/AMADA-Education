...
export const translations = {
  ...
  sidebar: {
    ...
    outreachEvents: { az: "Maarifləndirmə & tədbirlər", en: "Outreach & events", ru: "Работа с населением и события" },
    antiDoping: { az: "Dopinqə qarşı mübarizə", en: "Anti-doping", ru: "Антидопинг" },
    antiDopingViolations: { az: "Dopinqə qarşı qayda pozuntuları", en: "Anti-doping rule violations", ru: "Нарушения антидопинговых правил" },
    prohibitedList: { az: "Qadağan olunmuş siyahı", en: "Prohibited List", ru: "Запрещённый список" },
    testingProcedures: { az: "Sınaq prosedurları", en: "Testing procedures", ru: "Процедуры тестирования" },
    supplementsRisk: { az: "Əlavə qidaların riski", en: "Supplements risk", ru: "Риск пищевых добавок" },
    ...
    supportPersonnel: { az: "Dəstək heyəti", en: "Support personnel", ru: "Вспомогательный персонал" },
    medicalProfessionals: { az: "Tibb mütəxəssisləri", en: "Medical professionals", ru: "Медицинские работники" },
    parents: { az: "Valideynlər", en: "Parents", ru: "Родители" },
    federations: { az: "Federasiyalar", en: "Federations", ru: "Федерации" },
    tue: { az: "Terapevtik İstifadə İcazəsi", en: "Therapeutic Use Exemption", ru: "Терапевтическое исключение" },
    reportingSupport: { az: "Hesabatlılıq & Dəstək", en: "Reporting & Support", ru: "Отчётность и поддержка" },
  ...
  landing: {
    ...
    choosePathDesc: {
      az: "Sporttakı rolanıza əsasən uyğunlaşdırılmış dopinqə qarşı mübarizə məlumatları və resursları.",
  ...
  topicPages: {
    adrv: {
      ...
      keyFacts: {
        az: [
          ...
          "11. Hakimiyyətə bildiriş üzrə şikayətin qarşısını alan və ya intiqam alan hərəkətlər",
        ],
        en: [
          "1. Presence of a prohibited substance in your sample",
          "2. Use or attempted use of a prohibited substance/method",
          "3. Evading, refusing or failing to submit to sample collection",
          "4. Whereabouts failures (3 missed tests or filing failures in 12 months)",
    ...
    "testing-procedures": {
      ...
      keyFacts: {
        ...
        en: [
          ...
          "Chaperoning: You must remain under constant supervision from notification until the end.",
          "Sample Collection Kit Selection: You choose from several sealed collection kits.",
          "Provision of Sample: At least 90ml of urine must be provided.",
    ...
    "tue": {
      ...
      keyFacts: {
        ...
        en: [
          "Necessity: Use is required to treat an acute or chronic medical condition.",
          "No Alternative: There is no reasonable non-prohibited therapeutic alternative.",
    ...
    "supplements-risk": {
      ...
      keyFacts: {
        az: [
          "Zəif Tənzimləmə: Əlavə qida sənayesi dərman sənayesi kimi ciddi tənzimlənmir.",
        ...
        en: [
          ...
          "Hidden Ingredients: Prohibited substances are often not listed on labels.",
    ...
    "rights-and-responsibilities": {
      ...
      keyFacts: {
        ...
        en: [
          ...
          "Right: To ask for explanations and identification from the DCO.",
          "Right: To make comments on the Doping Control Form about the session.",
