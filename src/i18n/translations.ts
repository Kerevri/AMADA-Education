...
export const translations = {
  ...
  sidebar: {
    ...
    cleanSportTopics: { az: "Təmiz İdman Mövzuları", en: "Clean Sport Topics", ru: "Темы чистого спорта" },
    antiDopingViolations: { az: "Qayda pozuntuları", en: "Anti-Doping Rule Violations", ru: "Нарушения антидопинговых правил" },
    ...
    whereaboutsAdams: { az: "Yerlər haqqında məlumat & ADAMS", en: "Whereabouts & ADAMS", ru: "Местонахождение и ADAMS" },
    ...
    supplementsRisk: { az: "Əlavə qidaların riski", en: "Risk of Supplements", ru: "Риск пищевых добавок" },
    ...
    tue: { az: "Terapevtik İstifadə İcazəsi (Tİİ)", en: "Therapeutic Use Exemption", ru: "Терапевтическое исключение" },
